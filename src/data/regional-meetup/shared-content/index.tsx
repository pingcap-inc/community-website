...
import avatar_xfworld_Image from './avatars/xfworld.png';
import avata_hey_hoho_Image from './avatars/hey-hoho.png';
import avatar_Jellybean_Image from './avatars/Jellybean.png';
import avatar_bian_cheng_yuan_yuan_Image from './avatars/bian_cheng_yuan_yuan.png';
import avatar_a_fu_chris_Image from './avatars/a_fu_chris.png';
import avatar_zhang_tian_Image from './avatars/zhang_tian.png';
...
export const sharedContents: TSharedContents = {
  ...
  cw1997: {
    ...
    avatarImage: avatar_xfworld_Image,
  },
  //hey-hoho
  orgadmin: {
    ...
    avatarImage: avata_hey_hoho_Image,
  },
  //Jellybean
  wd05171: {
    ...
    avatarImage: avatar_Jellybean_Image,
  },
  //边城元元
  blogtest_0: {
    title: 'TiKV & TiFlash 加速复杂业务查询',
    description: '使用 TiKV 和 TiFlash 可以加速复杂查询，本文将介绍实现路径',
    authorName: '边城元元',
    authorTitle: '石家庄地区活动组织者',
    avatarImage: avatar_bian_cheng_yuan_yuan_Image,
  },
  //阿福Chiris
  orgtest3: {
    ...
    avatarImage: avatar_a_fu_chris_Image,
  },
  //数据小黑
  alfred: {
    ...
    avatarImage: avatar_zhang_tian_Image,
  },
};
