...
import styles from './mostValuableAdvocate.module.scss';
        ...
        <div className={styles.about}>
          ...
          <div className={styles.about_right}>
            ...
            <div className={styles.about_right_detail}>
              <p>
                TiDB 作为全球顶级开源项目，受到很多用户青睐，也被越来越多的技术工程师所认可，其中有很多人开始自发地输出
                TiDB 使用案例、最佳实践、原理解读、数据架构等内容。这些内容源自社区，也回馈于社区，促进了 TiDB
                技术的传播。为了鼓励更多用户输出优质技术内容，感谢他们在 TUG 社区内所做出的贡献，TUG 社区发起了“ MVA计划
                ”， 是社区颁发给技术专家的一项荣誉认证。
              </p>
              <p>
                TUG MVA （Most Valuable Advocate）、TUG MOA（Most Outstanding Advocate）是在 TUG
