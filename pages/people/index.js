    ...
    <div className={styles.wrapper}>
          ...
          <div className={styles.progress_left_step}>
            <div className={styles.progress_left_step_1}>
              ...
              <div className={styles.progress_left_step_1_text}>
                管理线：上升通道为 TUG 管理成员，包括 Team Co-Leader、Team Leader、TMC 成员。TUG 管理成员任期为一年。TMC
                成员、Team Leader 每年通过换届选举产生，Team Co-Leader 在换届选举后由 Team Leader 进行委任。
              </div>
            </div>
      ...
      <div className={styles.people}>
        <Container className={styles.people_content}>
          ...
          <div className={styles.people_content_summary}>TUG 各区域负责人，负责统筹本区域内TUG 的发展以及活动规划</div>
          <div className={styles.people_content_list}>
